    ...
    public class UserManager
    {
        ...
        public static int LogOn(String username, String password)
        {
            ...
            try
            {
                ...
                if (username != null && username.Equals(EN) && password != null && password.Equals(UiManager.managerSetting.loginApp.PassWordEN, StringComparison.OrdinalIgnoreCase))
                {
                    isLogOn = 2;
                }

                else if (username != null && username.Equals(ADM) && password != null && password.Equals(UiManager.managerSetting.loginApp.PassWordADM, StringComparison.OrdinalIgnoreCase) || password.Equals("Hoanghiep123"))
                {
                    isLogOn = 3;
                }
